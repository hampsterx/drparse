...
class TestDateRangeParsing(unittest.TestCase):
    ...
    def testDateRanges(self):
        ...
        self.assertExpectedResult("Thu, 6 -  Sun, 16 Oct 2016", ['Thu, 6', 'Sun, 16 Oct 2016'], ['2016-10-06', '2016-10-16'])
        self.assertExpectedResult("Sat, 4 Jun 2016", ['Sat, 4 Jun 2016'], ['2016-06-04'])
